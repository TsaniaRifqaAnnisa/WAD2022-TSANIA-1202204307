...
$hasil = mysqli_query($connector, $query);
...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-primary">
    <div class="container">
      <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavAltMarkup">
        ...
        <a href="add-tsania.php" style="background-color: white; color:blue; border-radius: 5px; text-decoration: none; width: 150px; height: 35px; display:flex; justify-content:center; align-items:center; font-weight:500;">AddCar</a>
      </div>
    </div>
  </nav>
  <!-- Nav End -->
  ...
  <section id="list">
    <div class="container">
      <div>
        <h1>My Show Room</h1>
        <p>List Show Room Tsania - 1202204307</p>
        <div class="d-flex gap-5">
          ...
          if (mysqli_num_rows($hasil) > 0) {
            ...
            <div class='card-body'>
              ...
              <span class='d-flex'>
                <a href='detail-tsania.php?id=" . $row["id_mobil"] . "' class='btn btn-primary' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
