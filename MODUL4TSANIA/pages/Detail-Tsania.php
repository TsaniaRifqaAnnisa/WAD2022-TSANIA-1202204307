...
<body>
    ...
    <main>
        <div class="container py-2">
            <h2><?php echo $resultSet[0]['nama_mobil'];?></h2>
            <p>Detail Mobil <?php echo $resultSet[0]['nama_mobil'];?></p>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input readonly type="text" class="form-control" id="car" name="car"
                            value="<?php echo $resultSet[0]['nama_mobil'];?>">
                    </div>
                    <div class="mb-3">
                        <label for="own" class="form-label">Nama Pemilik</label>
                        <input readonly type="text" class="form-control" id="owns" name="own"
                            value="<?php echo $resultSet[0]['pemilik_mobil'];?>">
                    </div>
                    <div class="mb-3">
                        <label for="merk" class="form-label">Merk</label>
                        <input readonly type="text" class="form-control" id="merk" name="merk"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea readonly class="form-control" id="desc" name="desc"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="paid" value="paid"
                                <?php if($resultSet[0]['status_pembayaran'] == "paid"){echo "checked";}?> disabled>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="npaid" value="npaid"
                                <?php if($resultSet[0]['status_pembayaran'] == "npaid"){echo "checked";}?> disabled>
                            <label class="form-check-label" for="npaid">
                                Belum Lunas
                            </label>
                        </div>
                    </div>
                    <a href="Edit-Tsania.php?id=<?php echo $resultSet[0]['id_mobil'];?>"
                        class="btn btn-<?php echo isset($_COOKIE['bg-nav'])? $_COOKIE['bg-nav'] : 'primary';?>">Edit</a>
                </div>
            </div>
        </div>
    </main>
